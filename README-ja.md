...
- メンテナー向けのリリースチェックリストとローカル優先スモークテスト transcript は完了しました。次の重点は完了レビューです。これらのリリース準備ドキュメントで cadence を保守に下げられるか、またはパッケージレジストリ公開を検討する前に残る最後のリリース準備ギャップがあるかを判断します。
