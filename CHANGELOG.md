...
- Add `bible-skill cache prune` for dry-run-first invalid cache recovery, confirmed removal of invalid translation cache directories, targeted translation IDs, and parseable JSON output.
